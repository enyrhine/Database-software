...
INSERT INTO Kayttaja (id, name, email, password, rooli) VALUES ('1', 'Elsa', 'elsa.nyrhinen@helsinki.fi', 'Elsa123', 'admin');
INSERT INTO Kayttaja (id, name, email, password, rooli) VALUES ('2', 'Testi', 'testi@helsinki.fi', 'Testi123', 'admin');
